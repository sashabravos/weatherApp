...
class WeatherViewController: UIViewController {
    ...
    // MARK: - Views
    var someView = MakeSomeView()
    var backgroundImage = MakeSomeView().makeImageView(UIImage(named: "background") ?? UIImage())
    ...
    var temperatureDegree = MakeSomeView().makeLabel("°", .left, 100.0, .light)
    var temperatureLiteral = MakeSomeView().makeLabel("C", .left, 100.0, .light)
    ...
    var emptyView = MakeSomeView().makeView()
